...
\section{Analiza i założenia projektu}
    ...
    \subsection{Określenie pracy wymaganej do wykonania projektu}
        ...
        Drugim rodzajem światła, będzie światło słoneczne. Stworzony będzie obiekt imitujący słońce, świecący chłodnym w swojej barwie światłem, ten typ światła będzie rzucał realistyczne cienie w pomieszczeniu. 
        \\
        
        Ostatnim typem światła będa obiekty, które będa lampami w pomieszczeniu. W każdej lampie będzie umieszczone osobne źródło światła, oraz skrypt pozwalający na kontrolowanie go. Kontroler oświetlenia będzie wyszukiwał wszystkie skrypty lamp oraz zmieniał ich ustawienie wedle potrzeb, traktując wszystkie lampy jako jedno grupowe oświetlenie.
        \\
        
        
        
        oraz skrypty które opisywać będą kolejne pozycje do których przenosić się będzie kamera.
        \\
        
        Przewidywane są trzy kształty paneli, trójkąt równoboczny, kwadrat i sześciokąt. Ułożenie każdego z nich odbywać się będzie w podobnej kolejności, ale odkległości oraz algroytm ich ułożenia będzie różnił się zależnie od kształtu, obrotu panela, oraz sposobu ułożenia.
        \\
...
\section{Realizacja projektu}
    ...
    \subsection{Projektowanie i programowanie logiki programu}
        ...
        \subsubsection{Skrypty}    
            ...
            Podobnym przypadkiem są sześciokąty, które zawsze muszą być ustawione naprzemiennie.
            \\
