...
\section{Realizacja projektu}
    ...
    \subsection{Projektowanie i programowanie logiki programu}
        ...
        \\
            ...
            Zawartośc menu po prawej będzie się zmieniać zależnie od aktywnego etapu, przyciski przenaczone dla każdego z nich będą przechowywane w osobnych kontenerach. Zależnie od sytaucji będzie pokazywany, lub chowany. Każdy z nich posiada nagłówek wyjaśniający jaki aspekt produktu zmieniać będziemy. Pod spodem będzie miejsce na przyciski, suwaki oraz inne wymagane elementy interfejsu.
            \\
