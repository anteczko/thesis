...
\section{Realizacja projektu}
    ...
    \subsection{Rozplanowanie scen i pomieszczeń}
        ...
        Pierwsze z nich jest fragmentem większego mieszania z aneksem kuchennym i osobnym pokojem. 
        \\
        \begin{center}
        ...
        Kolejny plan jest małą kawalerką. W tym przypadku modelowanie niewidocznych pomieszczeń i ich umeblowania nie jest wymagane, w tym przypadku łazienka nie będzie widoczna do wglądu, a jej drzwi będą zamknięte.
        \\
        \begin{center}
        ...
        Zależnie od ilości okien ilość światła naturalnego będzie większa lub mniejsza. W przypadku tego pokoju ilość światła słonecznego jest największa ze wszystkich przykładów.
        \\
        \begin{center}
    ...
    \subsection{Modelowanie elementów 3d}
        ...
        \subsubsection{Modelowanie listw ściennych}
            ...
            W taki sam sposób modelowane są listwy podsufitowe czasami nazywane sztukateriami. Różnicami będzie przesunięty punkt centralny modelu gdyż siatka będzie miała 1 metr a sufit będzie ustawiony na wysokości 2,5 metra. Kolejną różnicą będą dostępne wersje kolorystyczne z uwagi na różnice w materiałach 
            \\
